...
// Based on standard chess piece designs (Wikimedia Commons style)
...
// White pieces
export function WhiteKing({ size = 45 }: PieceProps) {
  return (
...
export function WhiteQueen({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function WhiteRook({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function WhiteBishop({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function WhiteKnight({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function WhitePawn({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
// Black pieces
export function BlackKing({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BlackQueen({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function BlackRook({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function BlackBishop({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BlackKnight({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
export function BlackPawn({ size = 45 }: PieceProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 45 45">
...
export function Piece({ type, color, size }: PieceComponentProps) {
